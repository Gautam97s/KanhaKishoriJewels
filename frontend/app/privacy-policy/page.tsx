...
export default function PrivacyPolicyPage() {
    return (
        <div className="container mx-auto px-4 py-16 max-w-4xl text-stone-800">
            <h1 className="font-serif text-4xl mb-8 text-stone-900 border-b border-gold-200 pb-4">Privacy Policy</h1>
            ...
            <div className="space-y-8 text-stone-600 leading-relaxed">
                <section>
                    ...
                    <p>
                        Kanha & Kishori ("we," "our," or "us") respects your privacy and is committed to protecting your personal data.
                ...
                <section>
                    <h2 className="text-xl font-bold text-stone-800 mb-3">4. Data Security</h2>
                    <p>
                ...
                <section>
                    ...
                    <p>
                        ...
                        <a href="mailto:privacy@kanhaandkishori.com" className="text-gold-600 hover:underline"> privacy@kanhaandkishori.com</a>.
                    </p>
                </section>
            </div>
        </div>
