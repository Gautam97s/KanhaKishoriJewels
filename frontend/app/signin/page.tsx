...
export default function SignIn() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Basic error handling assuming axios error structure
        ...
        <div className="min-h-screen flex items-center justify-center bg-beige-50 px-4">
            <div className="max-w-md w-full bg-white p-8 md:p-12 shadow-xl border border-stone-100 animate-fade-in">
                <div className="text-center mb-8">
                    ...
                    <p className="mt-4 text-stone-600 text-sm uppercase tracking-wider">Sign in to your account</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-center justify-between text-xs">
                        <label className="flex items-center space-x-2 cursor-pointer">
                            <input type="checkbox" className="form-checkbox text-terracotta-500 rounded border-stone-300 focus:ring-terracotta-500" />
                            <span className="text-stone-600">Remember me</span>
                        </label>
                        <a href="#" className="text-terracotta-600 hover:text-terracotta-700 transition-colors">Forgot Password?</a>
                    </div>
                ...
                <div className="mt-8 text-center border-t border-stone-100 pt-8">
                    <p className="text-stone-500 text-sm">
                        ...
                        <Link href="/signup" className="text-stone-900 font-bold hover:text-terracotta-600 transition-colors uppercase text-xs tracking-wider">
                            Create Account
                        </Link>
                    </p>
                </div>
